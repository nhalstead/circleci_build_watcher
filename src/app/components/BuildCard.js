		...
		return (
			<div className="build_card">
				...
				<div className="status-area" style={{paddingTop: "8px"}}>
					...
					<a href={url || "https://circleci.com"} target="_blank" rel={"noopener noreferrer"}
					...
					<div style={{marginLeft: "8px", marginTop: "-2px"}}>
						<span style={{color: "gray", fontSize: "12px"}}>
							...
							{data.hasPullRequests && (
								<a href={data.pullRequest.url} target="_blank" rel={"noopener noreferrer"}
								   style={{display: "inline-block", paddingLeft: "4px", position: "relative", top: "4px"}}>
									<PullRequest
										fill={"gray"}
										height={"18px"}
										width={"18px"}
